...
class Company(UUIDPrimaryKey, TimestampMixin, Base):
    ...
    include_patterns: Mapped[list | None] = mapped_column(JSONB(astext_type=Text()), nullable=True)
    exclude_patterns: Mapped[list | None] = mapped_column(JSONB(astext_type=Text()), nullable=True)
