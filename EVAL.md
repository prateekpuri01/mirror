...
|---|---|---|---|---|---|---|
| `ml_engineer_loose` | ✅ | 100% | 2.90 | 5 / 0 / 0 | 43 (43) | 487s |
| `ai_policy` | ❌ | — | — | 0 / 0 / 0 | 0 (0) | 1151s |

## Aggregate

- **Coverage:** 1/2 personas (50%) returned at least one hit
- **Mean relevance:** 2.90 / 5  _(LLM judge scoring of returned jobs against the search query)_
...
- **Mean wall time:** 819s per persona
...
- `dedup_dropped`: 9
- `tracked_no_match`: 2
- `direct_cap_reached`: 81
- `direct_miss`: 64
- `full_miss`: 125
- `final_hits`: 0

Top skip reasons:
  - `55` × Failed location/salary verification
  - `22` × No jobs in target location / above salary threshold
  - `18` × Lead skipped (filters active, can't verify)
  - `5` × No open jobs found
...
- **2/5** — Higharc / Sr. Software Engineer, Integrations  _(persona: `ml_engineer_loose`)_

---

_Generated from `hot_search` JSON at timestamp `20260428T182003Z`. To regenerate: `./backend/scripts/eval/run.sh`._
